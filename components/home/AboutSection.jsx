        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 px-4 md:px-8 items-center">
          ...
          >
            <div className="space-y-4 text-gray-500 leading-relaxed text-[15px] mb-8">
              <p>
                تعد إنترنت تيليكوم، منذ انطلاقتها عام 2015، الشركة الرائدة
                والوكيل الرسمي المعتمد لأكبر شركات الإنترنت في تركيا، تميزنا
                بكوننا الوجهة التقنية التي تربط المشترك العربي بأقوى حلول
                الإنترنت المنزلي عبر ارتباط مباشر بأنظمة التشغيل الرسمية
                (Systems)، مما يضمن وصول عملائنا إلى العروض الأكثر استقراراً
                بوضوح وشفافية تامة.
              </p>
              <p>
                من مركزنا في قلب إسطنبول، نمتد بخدماتنا لتشمل كافة الولايات
                التركية، حيث نتولى مسؤولية تحليل البنية التحتية في موقعكم لترشيح
                الخيار الأمثل فنياً، وتفعيل اشتراككم مباشرة عبر الأنظمة المعتمدة
                بكل سلاسة، مع التزامنا المطلق بتقديم كافة خدماتنا الاستشارية
                وتسهيلات التعاقد بشكل مجاني تماماً وبالأسعار الرسمية المعتمدة
                دون أي زيادة.
              </p>
              <p>
                نحن لا نقدم مجرد خدمة اتصال! بل تجربة متكاملة ترتكز على
                المصداقية، تبدأ من النصيحة الصادقة وتستمر عبر دعم فني متخصص
                باللغة العربية، مع الحفاظ على أعلى معايير الخصوصية لبيانات
                عملائنا، لنظل دائماً الجسر الأكثر أماناً وموثوقية للمشترك العربي
                في تركيا.
              </p>
              <p>المدير العام: أ. مهند التاجر</p>
            </div>
