  ...
  const options = [
    {
      ...
      icon: "/animations/Cross_Close_Cancel_Icon_Animation.json",
    ...
    },
    {
      name: "selectedService",
      value: "change-phone",
      selected: values.selectedService === "change-phone",
      icon: "/animations/Chat_Animation.json",
      title: "تغيير رقم الموبايل المثبت",
      description: "",
      size: "small",
      color: "indigo",
      titleSize: "text-lg",
