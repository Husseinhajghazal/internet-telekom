...
export const metadata = {
  ...
  title: "شركة إنترنت تيليكوم",
  description:
    "قدّم الآن على خط إنترنت جديد في تركيا بسهولة مع إنترنت تيليكوم. نوفر أفضل خدمات الإنترنت المنزلي، الاستعلام عن الإشتراك، وباقات تناسب جميع الاحتياجات في جميع المدن التركية.",
  keywords: [
    "إنترنت تركيا",
    "خط إنترنت جديد",
    "مزود إنترنت تركيا",
